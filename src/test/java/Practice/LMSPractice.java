...
public class LMSPractice {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//WebElement Element1 = mywait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='mantine-1wpc1xj mantine-Button-inner']")));  //span[text()='Admin']
		//Element1.click();
		...
		/*
		Thread.sleep(5000);
		driver.findElement(By.xpath("//span[text()='Add new module']")).click();                  //h5[text()='2. module 2']
		
		Thread.sleep(5000);
		driver.findElement(By.xpath("//input[@placeholder='Module name']")).sendKeys("Module1");
